...
public class DrawingPanel extends FileFilter implements ActionListener,
		MouseMotionListener, Runnable, WindowListener {
	...
	public DrawingPanel(int width, int height) {
		...
		if (DEBUG)
			System.out.println("w=" + width + ",h=" + height + ",anim="
					+ isAnimated() + ",graph=" + isGraphical() + ",save="
					+ shouldSave());
	...
	private BufferedImage getImage() {
		...
		if (DEBUG)
			System.out.println("getImage setting background to "
					+ backgroundColor);
		g.setColor(backgroundColor);
	...
	private class DiffImage extends JPanel implements ActionListener,
		...
		public void diff(InputStream input1, InputStream input2)
				throws IOException {
			diff(ImageIO.read(input1), ImageIO.read(input2));
		}
